...
template <bool remap, size_t size, size_t cell_size, size_t cache_line_size=128>
using ConditionalCacheRemap = std::conditional_t<remap && (size * cell_size >= cache_line_size),
        CacheRemap<size, cell_size, cache_line_size>, IdentityRemap>;
